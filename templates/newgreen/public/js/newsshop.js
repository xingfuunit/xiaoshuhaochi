...
{ 
  var url = siteurl+'/index.php?controller=shop&action=addcollect&datatype=json&collectid='+shopid+'&type=0'; 
...
function delFav()
{ 
	var url = siteurl+'/index.php?controller=shop&action=delcollect&datatype=json&collectid='+shopid+'&type=0'; 
  var backinfo = ajaxback(url,{});
  if(backinfo.flag == false){ 
      $('#AddFavShop').show(); 
      $('#CancelFavShop').hide();
