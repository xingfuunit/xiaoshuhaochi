...
function modifypwd()
{
	var showcontent = '<form method="post" name="form1" action="'+siteurl+'/index.php?controller=admin&action=modifypwd" onsubmit="return subform(\'\',this);"><div>旧密码:<input type="password" name="oldpwd" value=""></div><div style="padding-top:10px;">新密码:<input type="password" name="pwd" value=""></div><div style="padding-top:10px;padding-left:30px;"><input type="submit" value="确认提交" class="button"> </div> </form>';
	art.dialog({
    id: 'KDf435',
    title: '修改账号密码',
    content: showcontent
