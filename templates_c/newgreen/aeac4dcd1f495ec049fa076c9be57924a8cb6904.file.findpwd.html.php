<?php /* Smarty version Smarty-3.1.10, created on 2015-06-30 13:03:00
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/wmr_new/templates/newgreen/member/findpwd.html" */ ?>
<?php /*%%SmartyHeaderCode:1446312985592230451a417-64237497%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aeac4dcd1f495ec049fa076c9be57924a8cb6904' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/wmr_new/templates/newgreen/member/findpwd.html',
      1 => 1434531592,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1446312985592230451a417-64237497',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5592230466b752_01045615',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5592230466b752_01045615')) {function content_5592230466b752_01045615($_smarty_tpl) {?><!DOCTYPE html>
<html> 
<head>
<meta charset="utf-8" />
...
<div id="content">
	<form id="loginForm" method="post" action="<?php echo FUNC_function(array('type'=>'url','link'=>"/member/savefind/datatype/json"),$_smarty_tpl);?>
">
			...
			<div class="hc_login_content">
					<div class="findPassWordDiv">
						<div style="float:left;margin-right: 10px;">
							<span class="hc_login_div_span">邮箱：</span>
							<input onkeydown="if(event.keyCode==13)loginForm.submit()" class="hc_login_input" style="line-height: 38px; padding: 0 5px; margin: 0; border: 0; width: 252px; height: 38px; outline: none;" type="text" placeholder="请输入绑定邮箱" name="uname">
							<p class="tip"></p>
						</div>
						<div class="login-button hc_login_btn_div ">确 定</div>
						<div class="clear"></div>
					</div>
				<div class="clear"></div>
			</div>
