<?php /* Smarty version Smarty-3.1.10, created on 2015-06-30 18:12:28
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/wmr_new/templates/newgreen/member/regester.html" */ ?>
<?php /*%%SmartyHeaderCode:63896492755924096357110-30675453%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '180313a9e363d1d7b3c50c9be1120ad3a2e1f3d8' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/wmr_new/templates/newgreen/member/regester.html',
      1 => 1435659014,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '63896492755924096357110-30675453',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.10',
  'unifunc' => 'content_5592409651df14_66874376',
  'variables' => 
  array (
    'tempdir' => 0,
    'sitename' => 0,
...
<?php if ($_valid && !is_callable('content_5592409651df14_66874376')) {function content_5592409651df14_66874376($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_data')) include '/Applications/XAMPP/xamppfiles/htdocs/wmr_new/lib/Smarty/libs/plugins/function.load_data.php';
?><!DOCTYPE html>
<html> 
<head>
<meta charset="utf-8" />
...
">
         <ul>
   	  	...
   	  	<!--    <li id="showgetcode">
   	  	   	<!--  <label>&nbsp;</label>  --
   	  	   	  <input type="button" value="获取验证码" onclick="clickyanzheng();" class="inputgetcheck" time="0" id="dosendbtn"> 
   	  	   </li>
   	  	   -->
   	  	    <li id="showinputcode">
   	  	   	<!--  <label><font color=red>*</font>验证码：</label> -->
   	  	   	  <input type="text" name="phoneyan" id="phoneyan" placeholder="请输入验证码">
                 <input type="button" value="获取验证码" onclick="clickyanzheng();" class="inputgetcheck" time="0" id="dosendbtn"> 
   	  	 ...
   	  	 <!--  <div>
   	  	   ...
   	  	   -->
   	  	    ...
   	  	    <li id="imgcode">
   	  	   	  <label><font color=red>*</font>验证码：</label>
   	  	   	  <input type="text"  name="Captcha" id="Captcha"><img src="<?php echo FUNC_function(array('type'=>'url','link'=>"/site/getCaptcha"),$_smarty_tpl);?>
" id="captchaimg"><a href="javascript:freshcode();" >刷新图片</a>
   	  	   ...
   	  	   <li>
   	  	   <!--	  <label>&nbsp;</label> -->
   	  	      	<input name="reg[agree]" type="checkbox" checked="checked" disabled> 我接受<a target="_blank" href="<?php echo FUNC_function(array('type'=>'url','link'=>"/site/single/show/xieyi"),$_smarty_tpl);?>
...
.jpg">
   	     	...
   	     	<li class="apibottom">
   	     		已有帐号？<a href="<?php echo FUNC_function(array('type'=>'url','link'=>"/member/login"),$_smarty_tpl);?>
">立即登陆</a>|<a href="<?php echo FUNC_function(array('type'=>'url','link'=>"/member/findpwd"),$_smarty_tpl);?>
">找回密码</a>
   	     	</li>
   	  </ul>
