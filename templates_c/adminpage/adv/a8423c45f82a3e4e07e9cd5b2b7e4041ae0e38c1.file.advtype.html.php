<?php /* Smarty version Smarty-3.1.10, created on 2015-07-02 10:26:03
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/wmr_new/module/adv/adminpage/advtype.html" */ ?>
<?php /*%%SmartyHeaderCode:45025635455949fd98a9eb1-67736187%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a8423c45f82a3e4e07e9cd5b2b7e4041ae0e38c1' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/wmr_new/module/adv/adminpage/advtype.html',
      1 => 1435803871,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '45025635455949fd98a9eb1-67736187',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.10',
  'unifunc' => 'content_55949fd99a4d21_13461416',
  'variables' => 
  array (
    'tempdir' => 0,
    'siteurl' => 0,
...
<?php if ($_valid && !is_callable('content_55949fd99a4d21_13461416')) {function content_55949fd99a4d21_13461416($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Applications/XAMPP/xamppfiles/htdocs/wmr_new/lib/Smarty/libs/plugins/modifier.date_format.php';
?><!DOCTYPE HTML>
<html>
<head> 
<meta charset="utf-8"/> 
 ...
 <div class="right_content">
	<div class="show_content_m">
   	        <!--	 <div class="show_content_m_ti">
   	        	 	   <div class="showtop_t" id="positionname">广告类型列表</div>
   	        	 </div>  -->
  ...
  <div style="width:auto;overflow-x:hidden;overflow-y:auto">
          ...
          <div id="tagscontent">
            ...
            <div id="con_one_1">
              ...
              <div class="table_td" >
              <form method="post" action="<?php echo FUNC_function(array('type'=>'url','link'=>"/adminpage/adv/module/saveadvtype/datatype/json"),$_smarty_tpl);?>
" onsubmit="return subform('<?php echo FUNC_function(array('type'=>'url','link'=>"/adminpage/adv/module/advtype"),$_smarty_tpl);?>
',this);">
                  ...
                  <table border="0" cellspacing="2" cellpadding="4" class="list" name="table" id="table" width="100%">
                    ...
                    <tbody id="type">
                    	<?php if (!empty($_smarty_tpl->tpl_vars['advtype']->value)){?>
	 	                    <?php $_smarty_tpl->tpl_vars['list'] = new Smarty_variable(unserialize($_smarty_tpl->tpl_vars['advtype']->value), null, 0);?>
...
"  class='skey' style='width:50px;'/>
                        ...
                        <td align="center"> <a class="del" onclick="$(this).parent().parent().remove();" href="javascript:;"><img src="<?php echo $_smarty_tpl->tpl_vars['siteurl']->value;?>
/templates/<?php echo $_smarty_tpl->tpl_vars['tempdir']->value;?>
/public/images/admin/del.jpg"></a></td>
               ...
               <input type="submit" name="button" id="button" value="提交保存" class='button'>
                 ...
                 <input type="button" name="button" id="typebutton" value="添加一个类型" onclick="adddaohang();" class="button" />
