<?php /* Smarty version Smarty-3.1.10, created on 2015-05-21 09:57:14
         compiled from "D:\wmr\module\order\template\shoporderlist.html" */ ?>
<?php /*%%SmartyHeaderCode:23494555d3b7af3a6a6-35469762%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3b686841bc2d775d7588fee9f47c6309f55948e9' => 
    array (
      0 => 'D:\\wmr\\module\\order\\template\\shoporderlist.html',
      1 => 1407408146,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '23494555d3b7af3a6a6-35469762',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_555d3b7b2c8609_76152286',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_555d3b7b2c8609_76152286')) {function content_555d3b7b2c8609_76152286($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_data')) include 'D:\\wmr\\lib\\Smarty\\libs\\plugins\\function.load_data.php';
if (!is_callable('smarty_modifier_date_format')) include 'D:\\wmr\\lib\\Smarty\\libs\\plugins\\modifier.date_format.php';
...
/public/shopcenter/images/sdsx.png" /><span>手动刷新</span> </div>
        <div class="refset"> <img src="<?php echo $_smarty_tpl->tpl_vars['siteurl']->value;?>
/templates/<?php echo $_smarty_tpl->tpl_vars['tempdir']->value;?>
...
</span> <span style=" margin-left:30px;"><span class="oxx">下单时间</span>：<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['items']->value['addtime'],"%Y-%m-%d %H:%M:%S");?>
...
(<?php if ($_smarty_tpl->tpl_vars['items']->value['paystatus']==1){?>已付<?php }else{ ?>未付<?php }?>) <font color=red><?php echo $_smarty_tpl->tpl_vars['backarray']->value[$_smarty_tpl->tpl_vars['items']->value['is_reback']];?>
              ...
              <td><div>配送时间: <span><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['items']->value['posttime'],"%Y-%m-%d %H:%M:%S");?>
</span></div></td>
