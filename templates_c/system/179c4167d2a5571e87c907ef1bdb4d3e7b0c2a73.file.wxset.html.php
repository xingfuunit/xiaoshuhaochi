<?php /* Smarty version Smarty-3.1.10, created on 2015-07-02 16:40:01
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/wmr_new/module/weixin/template/wxset.html" */ ?>
<?php /*%%SmartyHeaderCode:12158062325594a4e9675364-50756821%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '179c4167d2a5571e87c907ef1bdb4d3e7b0c2a73' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/wmr_new/module/weixin/template/wxset.html',
      1 => 1435808245,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '12158062325594a4e9675364-50756821',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.10',
  'unifunc' => 'content_5594a4e9808191_32585730',
  'variables' => 
  array (
    'tempdir' => 0,
    'sitename' => 0,
...
<?php if ($_valid && !is_callable('content_5594a4e9808191_32585730')) {function content_5594a4e9808191_32585730($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_data')) include '/Applications/XAMPP/xamppfiles/htdocs/wmr_new/lib/Smarty/libs/plugins/function.load_data.php';
?><!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
">微信管理</a></li>
 ...
 <!--content right start-->
  <div class="conWaiSet fr">
    ...
    <div class="cl"></div>
    <form method="post" action="<?php echo FUNC_function(array('type'=>'url','link'=>"/weixin/wxsetsave"),$_smarty_tpl);?>
">
    <div class="jutiSet">
      <div class="serxuanze">
        ...
        <div class="dianpu_right">
          <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
" name="wxtoken" id="wxtoken">
        </div>
        <div class="cl"></div>
      </div>
      <div class="serxuanze">
        ...
        <div class="dianpu_right">
          <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['appid']->value;?>
" name="wxappid" id="wxappid">
        </div>
        <div class="cl"></div>
      </div>
      <div class="serxuanze">
        ...
        <div class="dianpu_right">
          <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['secret']->value;?>
" name="wxsecret" id="wxsecret">
        </div>
        <div class="cl"></div>
      </div>
      <div class="settijiao">
