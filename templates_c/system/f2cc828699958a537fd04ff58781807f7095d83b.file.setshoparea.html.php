<?php /* Smarty version Smarty-3.1.10, created on 2015-05-21 09:57:18
         compiled from "D:\wmr\module\area\template\setshoparea.html" */ ?>
<?php /*%%SmartyHeaderCode:10784555d3b7ea95196-93364085%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f2cc828699958a537fd04ff58781807f7095d83b' => 
    array (
      0 => 'D:\\wmr\\module\\area\\template\\setshoparea.html',
      1 => 1219375840,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '10784555d3b7ea95196-93364085',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_555d3b7ee8bc80_11750848',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_555d3b7ee8bc80_11750848')) {function content_555d3b7ee8bc80_11750848($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_data')) include 'D:\\wmr\\lib\\Smarty\\libs\\plugins\\function.load_data.php';
...
?>
                 	 <tr>
                        <td colspan="3" height=40px>&nbsp;  
                        	<div style="padding-top:5px;padding-left:<?php echo $_smarty_tpl->tpl_vars['items']->value['space']*30;?>
px;width:300px;float:left;" >
                        	    ...
                        	    <?php if (!in_array($_smarty_tpl->tpl_vars['items']->value['id'],$_smarty_tpl->tpl_vars['parent_ids']->value)){?>
                        	     ...
                        	     <?php if ($_smarty_tpl->tpl_vars['showcost']->value==1){?>
                   	    	     	 	    ...
                   	    	     	 	    <?php echo smarty_function_load_data(array('assign'=>"shoparea",'table'=>"areatoadd",'type'=>"one",'where'=>"areaid='".((string)$_smarty_tpl->tpl_vars['items']->value['id'])."' and shopid = 0",'fileds'=>"cost"),$_smarty_tpl);?>
                   	    	     	 	     ...
                   	    	     	 	     <font color=red style="font-weight:bold;"><?php echo $_smarty_tpl->tpl_vars['shoparea']->value['cost'];?>
元</font>
...
',this);" class="myinputon" maxlength=3  <?php if (empty($_smarty_tpl->tpl_vars['shopareacheck']->value)){?> style="display:none;"<?php }?> ></div>
