<?php /* Smarty version Smarty-3.1.10, created on 2015-07-02 16:41:20
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/wmr_new/module/shop/template/usershopnotice.html" */ ?>
<?php /*%%SmartyHeaderCode:5920169845593aad12c66f1-23246459%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1c937986007e64a9cc0cb0c5ad60c4878e61c89c' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/wmr_new/module/shop/template/usershopnotice.html',
      1 => 1435741044,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '5920169845593aad12c66f1-23246459',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.10',
  'unifunc' => 'content_5593aad14611d1_05777792',
  'variables' => 
  array (
    'tempdir' => 0,
    'sitename' => 0,
...
<?php if ($_valid && !is_callable('content_5593aad14611d1_05777792')) {function content_5593aad14611d1_05777792($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_data')) include '/Applications/XAMPP/xamppfiles/htdocs/wmr_new/lib/Smarty/libs/plugins/function.load_data.php';
?><!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
    ...
    <div class="conWaiSet fr">
            ...
            <div class="shopSetTop">
             ...
             <div class="cl"></div>  
             	...
             	<form id="loginForm" method="post" action="<?php echo FUNC_function(array('type'=>'url','link'=>"/shop/usershopnotice"),$_smarty_tpl);?>
" >
             	<div class="jutiSet">
                      ...
                      <tr> 
                        <td><script>KE.show({id:'notice_info',allowFileManager : true,imageUploadJson:'<?php echo FUNC_function(array('type'=>'url','link'=>"/other/saveupload"),$_smarty_tpl);?>
',fileManagerJson:'<?php echo FUNC_function(array('type'=>'url','link'=>"/other/saveupload"),$_smarty_tpl);?>
',items:['source','|', 'justifyleft', 'justifycenter', 'justifyright','justifyfull', 'insertorderedlist', 'insertunorderedlist', '|', 'fontname', 'fontsize', '|', 'textcolor', 'bgcolor', 'bold','italic', 'underline', 'removeformat', '|', 'image', 'advtable', 'hr','link', 'unlink']});</script><textarea name="notice_info" id="notice_info" style='width:100%; height:500px;'><?php echo $_smarty_tpl->tpl_vars['shopinfo']->value['notice_info'];?>
</textarea></td>
                      </tr> 
                      <tr>
