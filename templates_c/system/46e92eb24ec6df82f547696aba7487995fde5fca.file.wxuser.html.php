<?php /* Smarty version Smarty-3.1.10, created on 2015-07-02 13:13:58
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/wmr_new/module/weixin/template/wxuser.html" */ ?>
<?php /*%%SmartyHeaderCode:3910430265594aec08889a7-37323573%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '46e92eb24ec6df82f547696aba7487995fde5fca' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/wmr_new/module/weixin/template/wxuser.html',
      1 => 1435814035,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3910430265594aec08889a7-37323573',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.10',
  'unifunc' => 'content_5594aec0a71529_60592690',
  'variables' => 
  array (
    'tempdir' => 0,
    'sitename' => 0,
...
<?php if ($_valid && !is_callable('content_5594aec0a71529_60592690')) {function content_5594aec0a71529_60592690($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_data')) include '/Applications/XAMPP/xamppfiles/htdocs/wmr_new/lib/Smarty/libs/plugins/function.load_data.php';
?><!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
');">发送客服信息</a></td>
                       <td align="center">
                          <select name="is_merchant" onchange="setMerchant('<?php echo $_smarty_tpl->tpl_vars['items']->value['openid'];?>
',this.value)">
                            <option value="0" <?php if ($_smarty_tpl->tpl_vars['items']->value['is_merchant']==0){?>selected="selected"<?php }?>>否</option>
                            <option value="1" <?php if ($_smarty_tpl->tpl_vars['items']->value['is_merchant']==1){?>selected="selected"<?php }?>>是</option>
                          </select>
                       </td>
                      </tr>
                       <?php } ?>
...
<ul><?php echo $_smarty_tpl->tpl_vars['pagecontent']->value;?>
</ul>
           <!--     <div class="page_newc">
...
<script>
  function setMerchant(openid,val){
    $.post('<?php echo FUNC_function(array('type'=>'url','link'=>"/weixin/setmerchant/datatype/json"),$_smarty_tpl);?>
', {'openid':openid,'is_merchant':val},function (res, textStatus){
        var data = eval("("+res+")");
        if(data.error == false){
            art.dialog({
                    id: 'testID4',
    ...
    function showuser(openid,obj){
      $.post('<?php echo FUNC_function(array('type'=>'url','link'=>"/weixin/getoneuser/datatype/json"),$_smarty_tpl);?>
', {'openid':openid},function (data, textStatus){
   ...
   var  htmls = '<form method="post" name="form1" action="<?php echo FUNC_function(array('type'=>'url','link'=>"/weixin/sendwxmsg/datatype/json"),$_smarty_tpl);?>
