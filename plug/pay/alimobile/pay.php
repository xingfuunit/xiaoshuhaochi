...
//服务器异步通知页面路径
$notify_url = trim($alipay_config['notify_url']);//"http://m2.waimairen.com/plug/pay/halipay/notify_url.php";
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//页面跳转同步通知页面路径
$call_back_url = trim($alipay_config['return_url']);//"http://m2.waimairen.com/plug/pay/halipay/call_back_url.php";
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//操作中断返回地址
$merchant_url = trim($alipay_config['error_url']);//"http://m2.waimairen.com/plug/pay/halipay/xxxx.php";
